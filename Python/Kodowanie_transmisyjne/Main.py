...
from Utilities import tile, linspace,Wykres
...
Wykres(411,'CLK',t,clk)
Wykres(412,'TTL',t,ttl)
Wykres(413,'Manchester',t,manchesterSamples)
Wykres(414,'Manchester zdekodowany',tzz,manchestersTtl)
plt.show()
